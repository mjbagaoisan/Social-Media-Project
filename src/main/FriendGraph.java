...
public class FriendGraph {
     ...
     * @param userId The recommended friend's ID.
     * @param distance The degree of separation between the user and the recommended friend.
     * @param sharedInterests The number of shared interests between the user and the recommended friend.
     */
